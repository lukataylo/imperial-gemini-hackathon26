...
import com.gatekeeper.data.LedgerDigest
...
object PromptBuilder {
    ...
    fun buildSystemPrompt(
        ...
        return """
You are the gatekeeper on this person's phone. They asked you to stop them using $appName without thinking. Right now they are trying to open it and you are the only thing in the way.
